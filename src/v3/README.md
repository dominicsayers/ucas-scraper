...
```shell
. .venv/bin/activate
COURSE=physics STUDY_YEAR=2026 DESTINATION=Undergraduate PREDICTED_GRADES=ABC,BBC,BCC python src/v3/scripts/step_01_course_search.py
```
...
```shell
COURSE=physics STUDY_YEAR=2026 DESTINATION=Undergraduate PREDICTED_GRADES=ABC,BBC,BCC python src/v3/scripts/step_02_get_course_details.py
```
